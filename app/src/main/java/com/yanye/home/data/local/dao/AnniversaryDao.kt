...
interface AnniversaryDao {
    ...
    fun observeAnniversariesForCouple(coupleId: String): Flow<List<AnniversaryEntity>>
    ...
    suspend fun findActiveAnniversaryByName(name: String): AnniversaryEntity?
    ...
    suspend fun findActiveAnniversaryByNameForCouple(
        name: String,
        coupleId: String
    ): AnniversaryEntity?
    ...
    suspend fun pendingSyncAnniversariesForCouple(coupleId: String): List<AnniversaryEntity>
    ...
    suspend fun findByRemoteIdForCouple(remoteId: String, coupleId: String): AnniversaryEntity?
