...
interface RestaurantDao {
    ...
    fun observeRestaurantsForCouple(coupleId: String): Flow<List<RestaurantEntity>>
    ...
    suspend fun pendingSyncRestaurantsForCouple(coupleId: String): List<RestaurantEntity>
    ...
    suspend fun findByRemoteIdForCouple(remoteId: String, coupleId: String): RestaurantEntity?
